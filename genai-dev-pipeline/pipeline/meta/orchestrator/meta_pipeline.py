...
class MetaPipeline:
    def __init__(self, data_id: str, target_date: str, source_bucket: str, target_bucket: str):
    ...
    def run(self):
        ...
        for index, source_key in enumerate(source_files, start=1):
            ...
            target_file_key = f"transmit/{self.data_id}/{self.target_date}/{renamed_file}"
